...
const ContactButtons: React.FC = () => {
  ...
  return (
    <div className={`contact-buttons ${isVisible ? 'visible' : 'hidden'}`}>
      <button 
        className="contact-btn contact-btn-primary"
        onClick={handleContactClick}
        title="İletişime Geç"
      >
        <span className="btn-icon phone-icon">
          <img 
            src="/phone_enabled_24dp_E3E3E3_FILL0_wght400_GRAD0_opsz24.png" 
            alt="Telefon" 
            className="phone-icon-img"
          />
        </span>
        <span className="btn-text">İletişime Geç</span>
      </button>
      ...
      >
        <span className="btn-icon whatsapp-icon">
